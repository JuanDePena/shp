...
const copyByLocale: Record<WebLocale, WebCopy> = {
  en: {
    ...
    dashboardSubheading: "Operate nodes, jobs, backups, and platform resources from a single control surface.",
    ...
    actionPlanDescription: "Compare the platform resource catalog against the last successful apply and dispatch missing work.",
  actionImportDescription: "Use the transitional YAML import path to seed or recover the PostgreSQL resource catalog.",
  actionExportDescription: "Export the current resource catalog for audit, review, or disaster recovery.",
    ...
    bootstrapInventoryDescription: "Use YAML import only as a transitional bootstrap or disaster-recovery source. The PostgreSQL resource catalog remains authoritative.",
    ...
    backupPolicyContextDescription:
      "Policy metadata and linked operational scope.",
    ...
    desiredStateDescription: "Create and operate platform resources through object-specific workspaces.",
    desiredStateInventoryTitle: "Resource inventory",
    desiredStateInventoryDescription: "Review the current platform catalog before editing an individual record.",
    desiredStateEditorsTitle: "Resource configuration",
    desiredStateEditorsDescription: "Apply changes through these forms. Each save updates the PostgreSQL resource catalog.",
  ...
  es: {
    ...
    dashboardSubheading: "Opera nodos, jobs, backups y recursos de plataforma desde una sola consola.",
    ...
    actionPlanDescription: "Compara el catálogo de recursos de plataforma con la última aplicación exitosa y despacha el trabajo faltante.",
    actionImportDescription: "Usa la ruta YAML transicional para sembrar o recuperar el catálogo de recursos en PostgreSQL.",
    actionExportDescription: "Exporta el catálogo actual de recursos para auditoría, revisión o recuperación.",
    ...
    bootstrapInventoryDescription: "Usa la importación YAML solo como mecanismo transicional de bootstrap o disaster recovery. El catálogo de recursos en PostgreSQL sigue siendo autoritativo.",
    ...
    backupPolicyContextDescription:
      "Metadatos de la política y alcance operativo vinculado.",
    ...
    jobHistoryTitle: "Jobs",
    jobHistoryDescription: "Despachos recientes del control plane, resultados y estado de ejecución relacionado.",
    backupsTitle: "Backups",
    backupsDescription: "Últimas ejecuciones y cobertura actual de políticas.",
    desiredStateTitle: "Recursos",
    desiredStateDescription: "Crea y opera recursos de plataforma mediante workspaces por objeto.",
    desiredStateInventoryTitle: "Inventario de recursos",
    desiredStateInventoryDescription: "Revisa el catálogo actual de la plataforma antes de editar un registro individual.",
    desiredStateEditorsTitle: "Configuración del recurso",
    desiredStateEditorsDescription: "Aplica cambios mediante estos formularios. Cada guardado actualiza el catálogo de recursos en PostgreSQL.",
